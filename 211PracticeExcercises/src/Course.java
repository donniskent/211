...
public class Course {
	 ...
	 */
	public int getNumAssignments() // fixed to make sure numAssignments is >=1
	{
		if (numAssignments < 1) {
			return -1;
		}
	...
	/**
	 * Pass in the student name to add, returns true if student was added. Returns
	 * false if student was already enrolled in the course and could not be added.
	 */
	...
	/**
	 * Sets a grade for a particular assignment for the given student. Returns true
	 * if the grade could be set. Returns false if the student isn't in the course
	 * or the assignment number is illegal. Assignment number is from 1 to the
	 * maximum number of assignments. Grade must be at least 0.
	 */
	...
	/**
	 * Returns a grade for the given student and assignment. Returns -1 if any input
	 * is illegal, or the student isn't in the course.
	 */
	public int getStudentAssignmentGrade(int assignmentNumber, String name) {
		...
		int[] studentGrades = grades.get(name);
		return studentGrades[assignmentNumber];
	}
}