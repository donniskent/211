...
public class BackRoad extends State {
	...
	public void setMessage(ArrayList<String> message) {
		message.add(
				"You begin your path through the woods. It is extremely dark, you can only see 10 feet in front of yourself.");
		...
		message.add(
				"You find another body further up the road. You think the bodies were likely victims of an animal attack. ");
		...
		message.add(
				"It thrashes and mauls you, throwing you around like a rag-doll. You feel the blood soaking up inside your shirt. ");
		message.add(
		...
		if (getModel().getHasGun() == true) {
			...
			message.add(
					" begins to pounce on you again, before falling down without movement.");
			message.add("The stillness of the forest is eerie. There is no more chaos.");
			...
			message.add(
					"You explain to the police what had happened to you and they head to the crash site to investigate.");
			message.add("You lay in bed, thinking about how the fate of the two cold corpses could have easily been yours.");
			message.add(
